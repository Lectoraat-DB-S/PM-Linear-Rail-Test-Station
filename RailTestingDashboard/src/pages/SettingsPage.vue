...
export default defineComponent({
  ...
  setup() {
    ...
    const MaxTolSteek = ref(measurementStore.tolerance);

    const saveSettings = () => {
      measurementStore.setTolerance(MaxTolSteek.value);
      // You can add more logic to save MQTT and DB settings here
    };
      ...
      <q-tab-panel name="metingen">
        <div class="q-gutter-y-md column">
          ...
          <q-input
            ...
            style="max-width: 200px"
          />
          <q-btn @click="saveSettings" color="primary" text-color="black" label="Gegevens Opslaan" />
        </div>
      </q-tab-panel>
